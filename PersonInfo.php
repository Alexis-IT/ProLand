...
<html>
  ...
  <body>
	...
	<main>
      <!-- ********************  Contact Info about person  ********************* -->
      <section>
       <form action="Blank.php">
         <p>
           <label>Будь-ласка введіть контактну інформацію, щоб ми впевнилися  що ви реальна людина.</label>
         </p>
         <p class="formelement">
           <label>Ім'я</label>
         ...
         <p>
           <label>
             ...
             Я згідний/згідна на обробку переданих даних</a>
           </label>
         </p>
         <p>
           <button>
